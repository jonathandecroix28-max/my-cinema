<?php
// Service pour gérer la logique métier liée aux salles (ajout, modification, suppression, validation, etc.)
class RoomService
{
    private $roomRepo;
    ...
    /**
     * Récupérer les salles supprimées
     */
    ...
    /**
     * Vérifier si une salle a des séances futures
     */
