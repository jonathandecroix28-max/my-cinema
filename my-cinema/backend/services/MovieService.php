<?php
// Service pour gérer la logique métier liée aux films (ajout, modification, suppression, validation, etc.)
class MovieService
{
    private $movieRepo;
    ...
    public function addMovie($title, $description, $duration, $genre, $director, $release_year)
    {
        ...
        //  Vérifier si le film existe déjà (titre + année + réalisateur)
    ...
    public function updateMovie($id, $title, $description, $duration, $genre, $director, $release_year)
    {
        ...
        //  Vérifier si le film existe déjà (en excluant le film en cours de modification)
